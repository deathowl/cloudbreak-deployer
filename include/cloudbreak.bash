...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.9.0-dev.48
    env-import DOCKER_TAG_CLOUDBREAK 1.9.0-dev.48
    env-import DOCKER_TAG_ULUWATU 1.9.0-dev.48
    env-import DOCKER_TAG_SULTANS 1.9.0-dev.48
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.9.0-dev.48
